...
-- Started on 2022-09-22 10:19:34
...
--
-- TOC entry 212 (class 1259 OID 39166)
...
--
-- TOC entry 221 (class 1259 OID 39485)
...
--
-- TOC entry 213 (class 1259 OID 39175)
...
CREATE TABLE public.meal (
    ...
    imagefilename character varying(10485760)
);
...
--
-- TOC entry 214 (class 1259 OID 39189)
...
CREATE TABLE public.mealplan (
    ...
    imagefilename character varying(10485760),
    category character varying(10485760),
    dayofweek character varying(10485760),
    recipename character varying(10485760)
);
...
--
-- TOC entry 222 (class 1259 OID 39486)
-- Name: mealplan_mealplanid_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

ALTER TABLE public.mealplan ALTER COLUMN mealplanid ADD GENERATED ALWAYS AS IDENTITY (
    SEQUENCE NAME public.mealplan_mealplanid_seq
    START WITH 200
    INCREMENT BY 1
    MINVALUE 200
    MAXVALUE 99999999
...
--
-- TOC entry 215 (class 1259 OID 39203)
-- Name: mealplanmeal; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE public.mealplanmeal OWNER TO postgres;

--
-- TOC entry 218 (class 1259 OID 39266)
...
--
-- TOC entry 219 (class 1259 OID 39272)
-- Name: pantryingredient; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.pantryingredient (
    pantryid integer NOT NULL,
    ingredientid integer NOT NULL,
    quantity character varying NOT NULL,
    measurementunit character varying(255) NOT NULL,
    user_id integer DEFAULT 1 NOT NULL
);


ALTER TABLE public.pantryingredient OWNER TO postgres;

--
-- TOC entry 3397 (class 0 OID 0)
-- Dependencies: 219
-- Name: COLUMN pantryingredient.user_id; Type: COMMENT; Schema: public; Owner: postgres
--

COMMENT ON COLUMN public.pantryingredient.user_id IS 'to try and avoid using the p-key';


--
-- TOC entry 211 (class 1259 OID 38849)
...
CREATE TABLE public.recipe (
    ...
    cooktime integer,
    servingsize integer,
    instructions character varying(10485760),
    datecreated date,
    imagename character varying(10485760),
    visibility boolean,
    CONSTRAINT recipe_cook_time_min_check CHECK ((cooktime >= 0)),
    CONSTRAINT recipe_prep_time_min_check CHECK ((preptime >= 0)),
    CONSTRAINT recipe_serving_size_check CHECK ((servingsize > 0))
);
...
-- Dependencies: 211
-- Name: COLUMN recipe.visibility; Type: COMMENT; Schema: public; Owner: postgres
--

COMMENT ON COLUMN public.recipe.visibility IS 'Public: true
private: false';


--
-- TOC entry 220 (class 1259 OID 39484)
-- Name: recipe_recipeid_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

ALTER TABLE public.recipe ALTER COLUMN recipeid ADD GENERATED ALWAYS AS IDENTITY (
...
--
-- TOC entry 216 (class 1259 OID 39218)
...
--
-- TOC entry 217 (class 1259 OID 39234)
-- Name: recipemeal; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.recipemeal (
    recipeid integer NOT NULL,
    mealid integer NOT NULL
);


ALTER TABLE public.recipemeal OWNER TO postgres;

--
-- TOC entry 209 (class 1259 OID 38821)
...
--
-- TOC entry 210 (class 1259 OID 38822)
...
--
-- TOC entry 3381 (class 0 OID 39166)
-- Dependencies: 212
...
--
-- TOC entry 3382 (class 0 OID 39175)
-- Dependencies: 213
...
--
-- TOC entry 3383 (class 0 OID 39189)
-- Dependencies: 214
...
--
-- TOC entry 3384 (class 0 OID 39203)
-- Dependencies: 215
...
--
-- TOC entry 3387 (class 0 OID 39266)
-- Dependencies: 218
...
--
-- TOC entry 3388 (class 0 OID 39272)
-- Dependencies: 219
...
--
-- TOC entry 3380 (class 0 OID 38849)
-- Dependencies: 211
...
--
-- TOC entry 3385 (class 0 OID 39218)
-- Dependencies: 216
...
--
-- TOC entry 3386 (class 0 OID 39234)
-- Dependencies: 217
...
--
-- TOC entry 3379 (class 0 OID 38822)
-- Dependencies: 210
...
--
-- TOC entry 3214 (class 2606 OID 39172)
...
--
-- TOC entry 3216 (class 2606 OID 39183)
-- Name: meal meal_name_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.meal
    ADD CONSTRAINT meal_name_key UNIQUE (name);


--
-- TOC entry 3218 (class 2606 OID 39181)
-- Name: meal meal_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.meal
    ADD CONSTRAINT meal_pkey PRIMARY KEY (mealid);


--
-- TOC entry 3220 (class 2606 OID 39195)
-- Name: mealplan meal_plan_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.mealplan
    ADD CONSTRAINT meal_plan_pkey PRIMARY KEY (mealplanid);


--
-- TOC entry 3228 (class 2606 OID 39270)
-- Name: pantry pantry_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.pantry
    ADD CONSTRAINT pantry_pkey PRIMARY KEY (pantryid);


--
-- TOC entry 3230 (class 2606 OID 39276)
-- Name: pantryingredient pantryingredient_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.pantryingredient
    ADD CONSTRAINT pantryingredient_pkey PRIMARY KEY (pantryid, ingredientid);


--
-- TOC entry 3222 (class 2606 OID 39207)
-- Name: mealplanmeal pk_meal_plan_meal; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.mealplanmeal
    ADD CONSTRAINT pk_meal_plan_meal PRIMARY KEY (mealplanid, mealid);


--
-- TOC entry 3224 (class 2606 OID 39223)
-- Name: recipeingredient pk_recipe_ingredient; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.recipeingredient
    ADD CONSTRAINT pk_recipe_ingredient PRIMARY KEY (recipeid, ingredientid);


--
-- TOC entry 3226 (class 2606 OID 39238)
-- Name: recipemeal pk_recipe_meal; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.recipemeal
    ADD CONSTRAINT pk_recipe_meal PRIMARY KEY (recipeid, mealid);


--
-- TOC entry 3209 (class 2606 OID 38827)
...
--
-- TOC entry 3212 (class 2606 OID 39154)
...
--
-- TOC entry 3210 (class 1259 OID 39162)
-- Name: fki_fk_users_recipe_user_id; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX fki_fk_users_recipe_user_id ON public.recipe USING btree (user_id);


--
-- TOC entry 3234 (class 2606 OID 39208)
-- Name: mealplanmeal fk_meal_plan_meal_meal_id; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.mealplanmeal
    ADD CONSTRAINT fk_meal_plan_meal_meal_id FOREIGN KEY (mealid) REFERENCES public.meal(mealid);


--
-- TOC entry 3235 (class 2606 OID 39224)
-- Name: recipeingredient fk_recipe_ingredient_ingredient_id; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.recipeingredient
    ADD CONSTRAINT fk_recipe_ingredient_ingredient_id FOREIGN KEY (ingredientid) REFERENCES public.ingredient(ingredientid);


--
-- TOC entry 3236 (class 2606 OID 39229)
-- Name: recipeingredient fk_recipe_ingredient_recipe_id; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.recipeingredient
    ADD CONSTRAINT fk_recipe_ingredient_recipe_id FOREIGN KEY (recipeid) REFERENCES public.recipe(recipeid);


--
-- TOC entry 3237 (class 2606 OID 39239)
-- Name: recipemeal fk_recipe_meal_meal_id; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.recipemeal
    ADD CONSTRAINT fk_recipe_meal_meal_id FOREIGN KEY (mealid) REFERENCES public.meal(mealid);


--
-- TOC entry 3238 (class 2606 OID 39244)
-- Name: recipemeal fk_recipe_meal_recipe_id; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.recipemeal
    ADD CONSTRAINT fk_recipe_meal_recipe_id FOREIGN KEY (recipeid) REFERENCES public.recipe(recipeid);


--
-- TOC entry 3233 (class 2606 OID 39198)
-- Name: mealplan fk_users_meal_plan_user_id; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.mealplan
    ADD CONSTRAINT fk_users_meal_plan_user_id FOREIGN KEY (user_id) REFERENCES public.users(user_id);


--
-- TOC entry 3232 (class 2606 OID 39184)
-- Name: meal fk_users_meal_user_id; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.meal
    ADD CONSTRAINT fk_users_meal_user_id FOREIGN KEY (user_id) REFERENCES public.users(user_id);


--
-- TOC entry 3231 (class 2606 OID 39157)
-- Name: recipe fk_users_recipe_user_id; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.recipe
    ADD CONSTRAINT fk_users_recipe_user_id FOREIGN KEY (user_id) REFERENCES public.users(user_id);
...
-- Completed on 2022-09-22 10:19:35
